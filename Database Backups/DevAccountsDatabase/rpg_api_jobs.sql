...
CREATE TABLE `jobs` (
  ...
  `required_stats` varchar(255) NOT NULL,
  `stat_changes` varchar(255) NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `jobs` VALUES (1,'Store Bagger','General',40,5,'Bag Groceries for the citizens of RPGapi','{\"level\": 1}','{\"level\": 0.2}');
